...
import { fetchSources } from 'kaizoku-core/providers/movies/opstream';

export class OpstreamProvider extends BaseProvider {
    readonly id = 'opstream';
    readonly name = 'OpStream';
    readonly enabled = true;
    readonly BASE_URL = 'https://opstream.fun';
    ...
    async getTVSources(media: ProviderMediaObject): Promise<ProviderResult> { return this.fetchSources(media); }
